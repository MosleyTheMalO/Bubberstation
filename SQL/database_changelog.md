...
The latest database version is 5.32 (for bubberstation, 5.30 for skyrat) (5.28 for /tg/); The query to update the schema revision table is:
...
-----------------------------------------------------
Version 5.32, 1 November 2024, by Ghommie
